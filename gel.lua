...
function gel:leftcollide(a, b)
	...
	if a == "tile" then
		...
		if (inmap(x+1, y) and tilequads[map[x+1][y][1]].collision) or (inmap(x, y) and tilequads[map[x][y][1]].collision == false) or tilequads[map[x][y][1]].glass == true then
			return
		end
...
function gel:floorcollide(a, b)
	...
	if a == "tile" then
		...
		if (inmap(x, y-1) and tilequads[map[x][y-1][1]].collision) or (inmap(x, y) and tilequads[map[x][y][1]].collision == false) or tilequads[map[x][y][1]].glass == true then
			return
		end
		...
		if inmap(x, y) and tilequads[map[x][y][1]].collision and tilequads[map[x][y][1]].glass == false then
