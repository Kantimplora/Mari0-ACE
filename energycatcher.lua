...
function energycatcher:init(x, y, dir, r)
	...
	self.quad = energylauncherquad[spriteset][4]
	self.offsetX = 8
	self.offsetY = 0
	self.quadcenterX = 8
	self.quadcenterY = 8
...
function energycatcher:update(dt)
	if self.activated then
		...
		if self.ontime > 0.2 then
			self.quad = energylauncherquad[spriteset][6]
		elseif self.ontime > 0.1 then
			self.quad = energylauncherquad[spriteset][5]
		else
			self.quad = energylauncherquad[spriteset][4]
		end
	end
