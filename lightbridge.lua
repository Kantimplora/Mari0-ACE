...
function lightbridge:draw()
	...
	love.graphics.draw(lightbridgesideimg, lightbridgesidequad[spriteset], math.floor((self.cox-xscroll-.5)*16*scale), (self.coy-yscroll-1)*16*scale, rot, scale, scale, 8, 8)
end
