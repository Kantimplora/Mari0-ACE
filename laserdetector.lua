...
function laserdetector:draw()
	...
	love.graphics.draw(laserdetectorimg, laserdetectorquad[spriteset][quadi], math.floor((self.cox-xscroll-0.5)*16*scale), (self.coy-1-yscroll)*16*scale, rot, scale, scale, 8, 8)
end
